...
export function ColoredPreviousIcon(props: IconProps) {
  return (
    <svg width="12" height="18" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="M11 1 3 9l8 8" stroke="hsl(26, 100%, 55%)" strokeWidth="3" fill={'none'} fillRule="evenodd" />
    </svg>
  )
}

export function ColoredNextIcon(props: IconProps) {
  return (
    <svg width="13" height="18" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path d="m2 1 8 8-8 8" stroke="hsl(26, 100%, 55%)" strokeWidth="3"  fill='none' fillRule="evenodd" />
    </svg>
  )
}
